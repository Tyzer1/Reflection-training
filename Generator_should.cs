...
namespace Reflection.Randomness
{
    public class T1
    {
        [FromDestribution(typeof(NormalDistribution), 1, 2)]
    ...
    public class T2
    {
        ...
        [FromDestribution(typeof(ExponentialDistribution), 4)]
        [DisplayName("B-value")]
        ...
        [FromDestribution(typeof(NormalDistribution))]
    ...
    {
        // ReSharper disable once UnusedMember.Global
        [FromDestribution(typeof(NormalDistribution), 1, 2, 3)]
    ...
    {
        // ReSharper disable once UnusedMember.Global
        [FromDestribution(typeof(List), 1)]
